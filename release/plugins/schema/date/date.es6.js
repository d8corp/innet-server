...
const date = () => {
    const _a = useProps() || {}, { min, max, default: defaultValue, example, examples, values: values$1 } = _a, props = __rest(_a, ["min", "max", "default", "example", "examples", "values"]);
    ...
    const schema = useSchemaType('string', Object.assign(Object.assign({}, props), { values: stringValues, example: normExample === null || normExample === void 0 ? void 0 : normExample.toISOString(), 
        // @ts-expect-error: FIXME
